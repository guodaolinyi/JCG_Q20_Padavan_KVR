...
#define DEF_WLAN_2G_SSID	"爷也不让你用WiFi"
#define DEF_WLAN_5G_SSID	"爷也不让你用WiFi-5G"
#define DEF_WLAN_2G_GSSID	BOARD_PID "_GUEST_%s"
#define DEF_WLAN_5G_GSSID	BOARD_PID "_GUEST_5G_%s"
#define DEF_WLAN_2G_PSK		"t2ocuu4t!"
#define DEF_WLAN_5G_PSK		"t2ocuu4t!"

#define DEF_ROOT_PASSWORD	"GuoDao1996"
